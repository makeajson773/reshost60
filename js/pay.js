$(document).ready(function() {
	...
	function payNow(payType) {
		...
		case 1:
			{
				var content = '<div class="row justify-content-center"><h6 class="text-primary">本产品采用第三方话费充值方式，请放心支付！由于各地区网速不同，支付页面可能无法打开或打开较慢（部份地区需等待几十秒左右），<span class="text-success">如果无法打开支付页面，请切换不同的支付线路多次尝试！</span><span class="text-success">由于产品的特殊性质，导致在付款时可能会有风险提示，本产品保证没有任何欺诈情况,请放心付款！如遇支付失败，请联系人工客服（<a href="javascript:window.app.OpenURL(\'https://chat88.dotcomuse9.com/\');">点击这里与客服聊天</a>）进行人工充值或售后服务！</span></h6></div>';
